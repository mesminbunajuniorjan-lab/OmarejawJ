...
import { useGetRechargeHistory } from '@workspace/api-client-react';
import { Loader2, ArrowDownToLine, Clock, CheckCircle2, XCircle } from 'lucide-react';
import { format } from 'date-fns';
import { fr } from 'date-fns/locale';

export default function RechargeHistory() {
  const { data: history, isLoading } = useGetRechargeHistory();
      ...
      <div className="px-4 py-4">
        {!history || history.length === 0 ? (
          <div className="bg-white rounded-[24px] p-8 shadow-card border border-gray-50 text-center flex flex-col items-center mt-8">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">Aucune recharge</h3>
              ...
              return (
                <div key={tx.id} className="bg-white rounded-[20px] p-4 shadow-sm border border-gray-100 flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-gray-900">Recharge</h4>
