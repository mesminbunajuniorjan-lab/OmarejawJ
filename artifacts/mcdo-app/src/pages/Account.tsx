...
/* ── Shield decorative (balance card right) ── */
  ...
  return (
    <Link href={href}>
      <div style={{
        ...
        <p style={{ fontSize: 11, fontWeight: 700, color: '#111827', textAlign: 'center', lineHeight: 1.3, margin: 0 }}>
          {label}
        </p>
        <p style={{ fontSize: 10, color: '#9CA3AF', textAlign: 'center', lineHeight: 1.3, margin: 0 }}>
          {sub}
        </p>
      </div>
    </Link>
    ...
    <div style={{ fontFamily: 'Inter, sans-serif', background: '#F5F5FA', minHeight: '100vh', paddingBottom: 110 }}>
      ...
      <div style={{ background: DARK_BG }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 20px 4px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 3 }}>
              <div style={{ width: 24, height: 12, borderRadius: 3, border: '1.5px solid rgba(255,255,255,0.55)', display: 'flex', alignItems: 'center', padding: '1.5px' }}>
                <div style={{ width: 16, height: 7, background: 'white', borderRadius: 1.5 }} />
              </div>
              <div style={{ width: 20, height: 14, borderRadius: 4, background: '#E53E3E', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '10px 20px 14px' }}>
          <div style={{ background: P1, borderRadius: 22, padding: '6px 18px' }}>
            <span style={{ color: 'white', fontWeight: 700, fontSize: 14 }}>Lv1</span>
          </div>
          <button
            onClick={logout}
            style={{ display: 'flex', alignItems: 'center', gap: 6, color: 'white', fontWeight: 600, fontSize: 14, background: 'none', border: 'none', cursor: 'pointer', padding: 0 }}
          >
            Déconnexion
        ...
        <div style={{ padding: '0 14px 20px' }}>
          <div style={{
            ...
            {/* Sparkles */}
            <span style={{ position: 'absolute', top: 16, right: 108, color: 'rgba(255,255,255,0.55)', fontSize: 14, lineHeight: 1 }}>✦</span>
            <span style={{ position: 'absolute', top: 32, right: 140, color: 'rgba(255,255,255,0.25)', fontSize: 8, lineHeight: 1 }}>✦</span>
      ...
      <div style={{ background: 'white' }}>
        ...
        <div style={{ padding: '14px 14px 0' }}>
          <div style={{ borderRadius: 20, overflow: 'hidden', background: '#111118', position: 'relative', minHeight: 168 }}>
            {/* Text */}
            <div style={{ padding: '22px 20px 20px', position: 'relative', zIndex: 2, width: '55%' }}>
              <h3 style={{ color: 'white', fontWeight: 900, fontSize: 19, lineHeight: 1.25, margin: '0 0 6px' }}>
                Investissez dans nos packs
              </h3>
              <p style={{ color: 'rgba(255,255,255,0.72)', fontSize: 12, fontWeight: 500, margin: '0 0 18px' }}>
            ...
            <div style={{ position: 'absolute', right: 0, top: 0, bottom: 0, width: '52%' }}>
              <img src="/images/pack-bigmac.jpg" alt="Burger" style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center' }} />
              <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(90deg, #111118 0%, rgba(17,17,24,0.55) 50%, transparent 100%)' }} />
            </div>

            {/* Pagination dot */}
            <div style={{ position: 'absolute', bottom: 10, left: '50%', transform: 'translateX(-50%)', width: 8, height: 8, borderRadius: '50%', background: 'white' }} />
          </div>
        </div>

        {/* Plus de services */}
        <div style={{ padding: '20px 14px 10px' }}>
          <h2 style={{ fontSize: 16, fontWeight: 700, color: '#111827', margin: 0 }}>Plus de services</h2>
        </div>
        ...
        <div style={{ padding: '0 14px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 10 }}>
            ...
            <ServiceCard icon={CreditCard} label="Lier une carte bancaire" sub="Sécurisez vos retraits" iconBg="rgba(59,130,246,0.12)" iconColor="#3B82F6" href="/bank-accounts" />
        ...
        <div style={{ padding: '20px 14px 0' }}>
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, flex: 1, minWidth: 0 }}>
              <div style={{ width: 42, height: 42, borderRadius: '50%', background: 'rgba(106,61,240,0.22)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
            ...
            <button
              onClick={logout}
              style={{
                background: P1, borderRadius: 50, padding: '10px 16px',
